...
public class Vehicle {
    public static final int NUMBER_OF_AVAILABLE_SLOTS = 10;
            ...
            switch (menu) {
                case 1: {
                    ...
                    if (parkingArray.get(spotNumber) == null) {
                        ...
                        int parkingCost;
                        if(timeParked < 1 && timeParked >= 0) {
                            parkingCost = 4;
                            System.out.println("Cost to park: $" + parkingCost);
                        } else if (timeParked < 2 && timeParked >= 1) {
                            parkingCost = 8;
                            System.out.println("Cost to park: $" + parkingCost);
                        } else if (timeParked < 3 && timeParked >= 2) {
                            parkingCost = 12;
                            System.out.println("Cost to park: $" + parkingCost);
                        } else if (timeParked <= 5) {
                            parkingCost = 24;
                ...
                case 2: {
                    ...
                    if (parkingArray.get(spotNumber) == null) {
                            ...
                            parkingArray.remove(spotNumber);
                            System.out.println("You've left the structure.");
                    }
                    break;
                }
                case 3: {
                    for (int i = 0; i < NUMBER_OF_AVAILABLE_SLOTS; i++) {
                        if (parkingArray.get(i) == null) {
                            System.out.println("Spot #" + i + " is open");
                        } else {
                            System.out.println("Spot #" + i + " is occupied by car number REGISTRATION for TIMEPARKED");
                        }
                    }
                }
                case 0: {
